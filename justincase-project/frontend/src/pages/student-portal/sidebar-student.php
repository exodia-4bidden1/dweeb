...
<div id="sidebar" class="sidebar">
    ...
    <div class="menu-section">
        ...
        <ul class="menu-items">
            <li class="menu-item">
                <a href="./student-page.php" class="menu-link">
                    <i class="fas fa-desktop icon"></i>
                    Device Catalog
                </a>
            </li>
            <li class="menu-item">
                <a href="./2DI.html" class="menu-link">
    ...
    <div class="menu-section">
        ...
        <ul class="menu-items">
            <li class="menu-item">
                <a href="./3TR.html" class="menu-link">
                    <i class="fas fa-exchange-alt icon"></i>
                    Transactions
                </a>
            </li>
            <li class="menu-item">
                <a href="./4aLR.html" class="menu-link">
    ...
    <div class="menu-section">
        ...
        <ul class="menu-items">
            <li class="menu-item">
                <a href="./5AS.html" class="menu-link">
